...
# Create your models herua

class FoodCategory(TimeStampedModel):
    name_ua = models.CharField(verbose_name='Название на украинском', max_length=255, unique=True)
...
class Food(TimeStampedModel):
    ...
    name_ua = models.CharField(verbose_name='Название на украинском', max_length=255)
    description_ua = models.CharField(verbose_name='Описание на украинском', max_length=255, blank=True, null=True)
